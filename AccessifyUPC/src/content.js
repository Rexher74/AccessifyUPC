...
(function () {
  ...
  // "UPCAccessify" == "UPC Accessify" == "upc accessify".
  ...
  const BANNER_CSS = `
    ...
    .card {
      ...
      border: 1px solid #e3e3e3; border-top: 4px solid #0067b1;
    ...
    .btn {
      ...
      background: #0067b1; color: #fff; border: none; border-radius: 8px;
      padding: 11px 14px; font-size: 14px; font-weight: 600; cursor: pointer;
      transition: background .15s;
    }
    .btn:hover { background: #00558f; }
    .btn:disabled { background: #9bbdd6; cursor: default; }
    .btn.secondary { background: #eef4f9; color: #0067b1; }
    .btn.secondary:hover { background: #e0ecf5; }
    .footer { margin-top: 10px; text-align: center; }
    .link { background: none; border: none; color: #0067b1; cursor: pointer; font-size: 12px; text-decoration: underline; padding: 0; }
    .status { display: flex; align-items: center; gap: 9px; font-size: 13px; color: #333; }
    .spinner { width: 16px; height: 16px; border: 2px solid #cfe0ee; border-top-color: #0067b1; border-radius: 50%; animation: spin .7s linear infinite; flex: none; }
  ...
  function showLoginButton(cfg) {
    mount((card) => {
      header(card, "Accessify para la UPC", true);
  ...
  function showWorking(message) {
    mount((card) => {
      header(card, "Accessify para la UPC", false);
